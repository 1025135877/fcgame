...
export var Timer = function (props) {
    var _a = props.animate, animate = _a === void 0 ? false : _a, standardProps = __rest(props, ["animate"]);
    return (h("div", __assign({}, standardProps),
...
export var Square = function (props) { return (h("svg", __assign({ viewBox: "0 0 24 24" }, props),
    h("circle", { cx: "12", cy: "12", r: "2" }),
    h("rect", { width: "16", height: "16", x: "4", y: "4", rx: "2" }))); };
export var Close = function (props) { return (h("svg", __assign({ viewBox: "0 0 24 24" }, props),
    h("path", { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" }))); };
export var Star = function (props) { return (h("svg", __assign({ viewBox: "0 0 24 24" }, props),
...
export var RightClick = function (props) { return (h("svg", __assign({ viewBox: "0 0 24 24" }, props),
